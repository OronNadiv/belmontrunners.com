      ...
      <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48' width='24' height='24'>
        <g id='Layer_3' fillRule='evenodd' clipRule='evenodd'>
          ...
          <path
            ...
            fill='#e0e0e0' />
          <polygon points='33.986,26 31.637,26 31.637,19.782 28.083,19.83 28.083,18.136 33.986,17.492'
                   fill='#e0e0e0' />
          <path d='M6,9c-1.438,0-2.103,1.418-2,2c0.823,4.664,3,15,3,15' fill='#1976d2'
          />
          <path d='M41,26c0,0,2.177-10.336,3-15c0-1.625-1.409-2-2-2' fill='#1976d2'
          />
        </g>
      </svg>
    </SvgIcon>
